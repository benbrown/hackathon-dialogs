...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var PreAuthorizedApplicationPermission = {
    ...
    var PreAuthorizedApplicationExtension = {
    ...
    var ApplicationCreateParameters = {
        ...
        type: {
            ...
            modelProperties: __assign(__assign({}, ApplicationBase.type.modelProperties), { displayName: {
                    required: true,
                    serializedName: "displayName",
                    type: {
                        name: "String"
    ...
    var Application = {
        ...
        type: {
            ...
            modelProperties: __assign(__assign({}, DirectoryObject.type.modelProperties), { appId: {
                    serializedName: "appId",
                    type: {
                        name: "String"
                    }
    ...
    var ServicePrincipalObjectResult = {
    ...
    var ADGroup = {
        ...
        type: {
            ...
            uberParent: "DirectoryObject",
            className: "ADGroup",
            modelProperties: __assign(__assign({}, DirectoryObject.type.modelProperties), { displayName: {
                    serializedName: "displayName",
                    type: {
                        name: "String"
                    }
    ...
    var ServicePrincipalCreateParameters = {
        ...
        type: {
            ...
            modelProperties: __assign(__assign({}, ServicePrincipalBase.type.modelProperties), { appId: {
                    required: true,
                    serializedName: "appId",
                    type: {
                        name: "String"
    ...
    var ServicePrincipalUpdateParameters = {
        ...
        type: {
            ...
            modelProperties: __assign({}, ServicePrincipalBase.type.modelProperties)
        }
    };
    var ServicePrincipal = {
        ...
        type: {
            ...
            modelProperties: __assign(__assign({}, DirectoryObject.type.modelProperties), { accountEnabled: {
                    serializedName: "accountEnabled",
                    type: {
                        name: "Boolean"
                    }
    ...
    var UserCreateParameters = {
        ...
        type: {
            ...
            modelProperties: __assign(__assign({}, UserBase.type.modelProperties), { accountEnabled: {
                    required: true,
                    serializedName: "accountEnabled",
                    type: {
                        name: "Boolean"
    ...
    var User = {
        ...
        type: {
            ...
            uberParent: "DirectoryObject",
            className: "User",
            modelProperties: __assign(__assign({}, DirectoryObject.type.modelProperties), { immutableId: {
                    serializedName: "immutableId",
                    type: {
                        name: "String"
                    }
    ...
    var OAuth2PermissionGrantListResult = {
    ...
    var mappers = /*#__PURE__*/Object.freeze({
        ...
        PreAuthorizedApplicationPermission: PreAuthorizedApplicationPermission,
        PreAuthorizedApplicationExtension: PreAuthorizedApplicationExtension,
        ...
        ServicePrincipalObjectResult: ServicePrincipalObjectResult,
        ...
        ServicePrincipalBase: ServicePrincipalBase,
        ...
        OAuth2PermissionGrantListResult: OAuth2PermissionGrantListResult,
    ...
    var Applications = /** @class */ (function () {
        ...
        Applications.prototype.getServicePrincipalsIdByAppId = function (applicationID$$1, options, callback) {
            return this.client.sendOperationRequest({
    ...
    var createOperationSpec = {
        ...
        requestBody: {
            ...
            mapper: __assign(__assign({}, ApplicationCreateParameters), { required: true })
        },
        responses: {
            201: {
    ...
    var patchOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, ApplicationUpdateParameters), { required: true })
        },
        responses: {
            204: {},
            default: {
    ...
    var addOwnerOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, AddOwnerParameters), { required: true })
        },
        responses: {
            204: {},
            default: {
    ...
    var updateKeyCredentialsOperationSpec = {
        ...
        requestBody: {
            ...
            mapper: __assign(__assign({}, KeyCredentialsUpdateParameters), { required: true })
        },
        responses: {
            204: {},
            default: {
    ...
    var updatePasswordCredentialsOperationSpec = {
        ...
        requestBody: {
            ...
            mapper: __assign(__assign({}, PasswordCredentialsUpdateParameters), { required: true })
        },
        responses: {
            204: {},
            default: {
    ...
    var getServicePrincipalsIdByAppIdOperationSpec = {
        ...
        responses: {
            200: {
                bodyMapper: ServicePrincipalObjectResult
            },
            default: {
                bodyMapper: GraphError
            }
    ...
    var isMemberOfOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, CheckGroupMembershipParameters), { required: true })
        },
        responses: {
            200: {
    ...
    var addMemberOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, GroupAddMemberParameters), { required: true })
        },
        responses: {
            204: {},
            default: {
    ...
    var getMemberGroupsOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, GroupGetMemberGroupsParameters), { required: true })
        },
        responses: {
            200: {
    ...
    var createOperationSpec$2 = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, ServicePrincipalCreateParameters), { required: true })
        },
        responses: {
            201: {
    ...
    var updateOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, ServicePrincipalUpdateParameters), { required: true })
        },
        responses: {
            204: {},
            default: {
    ...
    var getMemberGroupsOperationSpec$1 = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, UserGetMemberGroupsParameters), { required: true })
        },
        responses: {
            200: {
    ...
    var getObjectsByObjectIdsOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, GetObjectsParameters), { required: true })
        },
        responses: {
            200: {
                bodyMapper: DirectoryObjectListResult
    ...
    var OAuth2PermissionGrantOperations = /** @class */ (function () {
        /**
         * Create a OAuth2PermissionGrantOperations.
         * @param {GraphRbacManagementClientContext} client Reference to the service client.
         */
        function OAuth2PermissionGrantOperations(client) {
            this.client = client;
        }
        OAuth2PermissionGrantOperations.prototype.list = function (options, callback) {
            return this.client.sendOperationRequest({
                options: options
            }, listOperationSpec$6, callback);
        };
        OAuth2PermissionGrantOperations.prototype.create = function (options, callback) {
            return this.client.sendOperationRequest({
                options: options
            }, createOperationSpec$4, callback);
        };
        OAuth2PermissionGrantOperations.prototype.deleteMethod = function (objectId$$1, options, callback) {
            return this.client.sendOperationRequest({
                objectId: objectId$$1,
                options: options
            }, deleteMethodOperationSpec$4, callback);
        };
        OAuth2PermissionGrantOperations.prototype.listNext = function (nextLink$$1, options, callback) {
            return this.client.sendOperationRequest({
                nextLink: nextLink$$1,
                options: options
    ...
    var listOperationSpec$6 = {
        ...
        responses: {
            200: {
                bodyMapper: OAuth2PermissionGrantListResult
            },
            default: {
                bodyMapper: CloudError
            }
    ...
    var createOperationSpec$4 = {
        ...
        requestBody: {
            ...
            mapper: OAuth2PermissionGrant
        },
        responses: {
            201: {
                bodyMapper: OAuth2PermissionGrant
            },
            default: {
                bodyMapper: CloudError
            }
    ...
    var GraphRbacManagementClientContext = /** @class */ (function (_super) {
        ...
        function GraphRbacManagementClientContext(credentials, tenantID, options) {
            ...
            _this.baseUri = options.baseUri || "https://graph.windows.net";
    ...
    var GraphRbacManagementClient = /** @class */ (function (_super) {
        ...
        function GraphRbacManagementClient(credentials, tenantID, options) {
            ...
            _this.oAuth2PermissionGrant = new OAuth2PermissionGrantOperations(_this);
            return _this;
        }
    ...
    exports.OAuth2PermissionGrantOperations = OAuth2PermissionGrantOperations;
